...
// getThreads returns the PR's review threads with their comments (§7.3).
...
// getPendingReview returns the viewer's draft review, driving resume (§7.3).
...
// getTimeline returns the PR's conversation comments + submitted review verdicts (§7.3).
...
// getChecks returns the status-check rollup for the PR (§7.3).
